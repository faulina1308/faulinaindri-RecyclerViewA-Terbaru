package com.example.faulinaindri;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm = new NegaraModel();
        nm.setNama("Slovenia");
        nm.setDeskripsi("Slovenia terletak di Eropa Tengah dan Tenggara menyentuh Pegunungan Alpen dan berbatasan dengan Laut Mediterania");
        ...
        nm = new NegaraModel();
        nm.setNama("Canada");
        nm.setDeskripsi("Negara ini terdapat disebelah utara Amerika Serikat");
        ...
        NegaraAdapater na = new NegaraAdapater(getApplicationContext(), negaraModelList);
